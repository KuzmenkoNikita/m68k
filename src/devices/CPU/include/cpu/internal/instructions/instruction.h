...
public:
    ...
    Instruction(const InstructionData::BCHG_Immediate_InstructionData& data);
    Instruction(const InstructionData::BCHG_Register_InstructionData& data);
    ...
    Instruction(const InstructionData::BTST_Immediate_InstructionData& data);
    Instruction(const InstructionData::BTST_Register_InstructionData& data);

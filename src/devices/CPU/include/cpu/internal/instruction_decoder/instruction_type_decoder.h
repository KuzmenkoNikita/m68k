...
private:
    std::array<OpcodeIndo, 96> opcodeTable_ = { //NOLINT(*-magic-numbers)
        ...
        OpcodeIndo{.mask=OPCODE_MASK_BTST_DATA, .pattern=OPCODE_PATTERN_BTST_DATA, .type=InstructionType::BTST_IMMEDIATE},
        OpcodeIndo{.mask=OPCODE_MASK_BTST_REG, .pattern=OPCODE_PATTERN_BTST_REG, .type=InstructionType::BTST_REGISTER},
        OpcodeIndo{.mask=OPCODE_MASK_BCHG_DATA, .pattern=OPCODE_PATTERN_BCHG_DATA, .type=InstructionType::BCHG_IMMEDIATE},
        OpcodeIndo{.mask=OPCODE_MASK_BCHG_REG, .pattern=OPCODE_PATTERN_BCHG_REG, .type=InstructionType::BCHG_REGISTER},
        OpcodeIndo{.mask=OPCODE_MASK_BCLR_DATA, .pattern=OPCODE_PATTERN_BCLR_DATA, .type=InstructionType::BCLR_IMMEDIATE},
        OpcodeIndo{.mask=OPCODE_MASK_BCLR_REG, .pattern=OPCODE_PATTERN_BCLR_REG, .type=InstructionType::BCLR_REGISTER},
        OpcodeIndo{.mask=OPCODE_MASK_BSET_DATA, .pattern=OPCODE_PATTERN_BSET_DATA, .type=InstructionType::BSET_IMMEDIATE},
        OpcodeIndo{.mask=OPCODE_MASK_BSET_REG, .pattern=OPCODE_PATTERN_BSET_REG, .type=InstructionType::BSET_REGISTER},
        ...
        OpcodeIndo{.mask=OPCODE_MASK_ASL_MEMORY, .pattern=OPCODE_PATTERN_ASL_MEMORY, .type=InstructionType::ASL_MEMORY},
        OpcodeIndo{.mask=OPCODE_MASK_ASL_REG, .pattern=OPCODE_PATTERN_ASL_REG, .type=InstructionType::ASL_REG},
        OpcodeIndo{.mask=OPCODE_MASK_ASR_MEMORY, .pattern=OPCODE_PATTERN_ASR_MEMORY, .type=InstructionType::ASR_MEMORY},
        OpcodeIndo{.mask=OPCODE_MASK_ASR_REG, .pattern=OPCODE_PATTERN_ASR_REG, .type=InstructionType::ASR_REG},
        OpcodeIndo{.mask=OPCODE_MASK_LSL_MEMORY, .pattern=OPCODE_PATTERN_LSL_MEMORY, .type=InstructionType::LSL_MEMORY},
        OpcodeIndo{.mask=OPCODE_MASK_LSL_REG, .pattern=OPCODE_PATTERN_LSL_REG, .type=InstructionType::LSL_REG},
        OpcodeIndo{.mask=OPCODE_MASK_LSR_MEMORY, .pattern=OPCODE_PATTERN_LSR_MEMORY, .type=InstructionType::LSR_MEMORY},
        OpcodeIndo{.mask=OPCODE_MASK_LSR_REG, .pattern=OPCODE_PATTERN_LSR_REG, .type=InstructionType::LSR_REG},
        OpcodeIndo{.mask=OPCODE_MASK_ROXL_MEMORY, .pattern=OPCODE_PATTERN_ROXL_MEMORY, .type=InstructionType::ROXL_MEMORY},
        OpcodeIndo{.mask=OPCODE_MASK_ROXL_REG, .pattern=OPCODE_PATTERN_ROXL_REG, .type=InstructionType::ROXL_REG},
        OpcodeIndo{.mask=OPCODE_MASK_ROXR_MEMORY, .pattern=OPCODE_PATTERN_ROXR_MEMORY, .type=InstructionType::ROXR_MEMORY},
        OpcodeIndo{.mask=OPCODE_MASK_ROXR_REG, .pattern=OPCODE_PATTERN_ROXR_REG, .type=InstructionType::ROXR_REG},

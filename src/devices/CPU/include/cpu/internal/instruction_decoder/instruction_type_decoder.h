...
private:
    std::array<OpcodeIndo, 96> opcodeTable_ = { //NOLINT(*-magic-numbers)
        ...
        OpcodeIndo{.mask=OPCODE_MASK_LSL_MEMORY, .pattern=OPCODE_PATTERN_LSL_MEMORY, .type=InstructionType::LSd},
        OpcodeIndo{.mask=OPCODE_MASK_LSL_REG, .pattern=OPCODE_PATTERN_LSL_REG, .type=InstructionType::LSd},
        OpcodeIndo{.mask=OPCODE_MASK_LSR_MEMORY, .pattern=OPCODE_PATTERN_LSR_MEMORY, .type=InstructionType::LSd},
        OpcodeIndo{.mask=OPCODE_MASK_LSR_REG, .pattern=OPCODE_PATTERN_LSR_REG, .type=InstructionType::LSd},

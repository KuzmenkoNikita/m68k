...
private:
    std::array<OpcodeIndo, 96> opcodeTable_ = { //NOLINT(*-magic-numbers)
        ...
        OpcodeIndo{.mask=OPCODE_MASK_ASL_MEMORY, .pattern=OPCODE_PATTERN_ASL_MEMORY, .type=InstructionType::ASd},
        OpcodeIndo{.mask=OPCODE_MASK_ASL_REG, .pattern=OPCODE_PATTERN_ASL_REG, .type=InstructionType::ASd},
        OpcodeIndo{.mask=OPCODE_MASK_ASR_MEMORY, .pattern=OPCODE_PATTERN_ASR_MEMORY, .type=InstructionType::ASd},
        OpcodeIndo{.mask=OPCODE_MASK_ASR_REG, .pattern=OPCODE_PATTERN_ASR_REG, .type=InstructionType::ASd},

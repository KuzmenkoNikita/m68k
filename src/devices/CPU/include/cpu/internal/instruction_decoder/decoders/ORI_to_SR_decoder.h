...
class ORI_to_SR_Decoder final : public IDecoder
{
public:
    explicit ORI_to_SR_Decoder(std::shared_ptr<DataExchange::MemoryInterface> bus);
    ~ORI_to_SR_Decoder() override = default;
